...
public class CrescentGrizzlyBoss : MonoBehaviour
{

    public static CrescentGrizzlyBoss instance;
    public SpriteRenderer sprite;
    public GameObject Explosion_1;
    public GameObject CrescentGrizzlyDeathEffect;
    ...
    {
        Instantiate(CrescentGrizzlyDeathEffect, transform.position, transform.rotation);
